  ...
  return (
    <Grid container spacing={2}>
      <Grid item xs={12} sm={6}>
        <TextField fullWidth label="Phòng ban" name="departmentId" value={employee.departmentId} required readOnly />
      </Grid>
      <Grid item xs={12} sm={6}>
      ...
      <Grid item xs={12} sm={6}>
        <TextField fullWidth label="Mã nhân viên" name="employeeCode" value={employee.employeeCode} required readOnly />
      </Grid>
      <Grid item xs={12} sm={6}>
